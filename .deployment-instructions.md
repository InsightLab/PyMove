...
6.  Add the following attributes to the `.travis.yml` file:
```yaml
    language: python
...
7.  Go to the folder where your .travis.yml file is and run `travis encrypt your-api-token --add deploy.password`
