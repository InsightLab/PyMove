...
def elbow_method(move_data, k_initial=1, maxClusters=15, k_iteration=1):
    ...
    maxClusters: int, optional (15  by default).
...
def gap_statistic(move_data, nrefs=3, maxClusters=15, k_initial=1, k_iteration=1):
