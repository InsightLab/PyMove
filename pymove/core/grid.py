...
class Grid():
    ...
    def _create_virtual_grid(self, data, cell_size, meters_by_degree):
        ...
        operation = lastoperation.begin_operation('_create_virtual_grid')
    ...
    def create_update_index_grid_feature(self, data, label_dtype=np.int64, sort=True):
        ...
        """
        operation = lastoperation.begin_operation('create_update_index_grid_feature')
    ...
    def create_one_polygon_to_point_on_grid(self, index_grid_lat, index_grid_lon):
        ...
        """
        operation = lastoperation.begin_operation('create_one_polygon_to_point_on_grid')
    ...
    def create_all_polygons_on_grid(self):
        ...
        operation = lastoperation.begin_operation('create_all_polygons_on_grid')
        try:
    ...
    def create_all_polygons_to_all_point_on_grid(self, data):
        ...
        """
        operation = lastoperation.begin_operation('create_all_polygons_to_all_point_on_grid')
        try:
    ...
    def save_grid_pkl(self, filename):
        ...
        """
        operation = lastoperation.begin_operation('save_grid_pkl')
        try:
    ...
    def read_grid_pkl(self, filename):
        ...
        dic_grid : dict
            Contains informations about virtual grid, how
                ...
                - cell_size_by_degree: tamanho da célula da Grid.
        """
        operation = lastoperation.begin_operation('read_grid_pkl')
        try:
    ...
    def show_grid_polygons(self, data, id_, figsize=(10,10), return_fig=True, save_fig=False, name='grid.png'):   
        ...
        operation = lastoperation.begin_operation('show_grid_polygons')
