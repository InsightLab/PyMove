...
def folium_plot_bbox(
    ...
    """
    Generate a bbox plot with folium.

    Parameters:
    -----------
    bbox_tuple: tuple.
        A 4-tuple with the  bbox coordinates.
    titles: string, optional, default 'OpenStreetMap'.
        Folium tiles type.
    color: string, optional, default red.
        the color of bbox.
    save: boolian, optional, default False.
        Whether to save or not.
    filename: string, optional, default 'bbox_.html'.
        the of the bbox.
    """
    m = folium.Map(tiles=tiles)
    m.fit_bounds([[bbox_tuple[0], bbox_tuple[1]], [bbox_tuple[2], bbox_tuple[3]]])
    tnz_points_ = [
        (bbox_tuple[0], bbox_tuple[1]), (bbox_tuple[0], bbox_tuple[3]),
...
def heatmap_with_time(
    df_, n_rows, lat_origin=None, lon_origin=None, zoom_start=12,
    radius=5, min_opacity=0.5, max_opacity=0.8, base_map=None,
    save_as_html=False, filename='heatmap_with_time.html'
):
    """
    ...
    save_as_html: boolean, optional, default False.
        Whether to save as html or not.
    ...
    HeatMapWithTime(
        df_hour_list[:n_rows], radius=radius,
        gradient={0.2: 'blue', 0.4: 'lime', 0.6: 'orange', 1: 'red'},
        min_opacity=min_opacity, max_opacity=max_opacity, use_local_extrema=True
    ).add_to(base_map)
