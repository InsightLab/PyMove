...
def test_union_poi_bank(df_, label_poi=TYPE_POI):
    """
...
def test_union_poi_bus_station(df_, label_poi=TYPE_POI):
    """
...
def test_union_poi_bar_restaurant(df_, label_poi=TYPE_POI):
    """
...
def test_union_poi_parks(df_, label_poi=TYPE_POI):
    """
...
def test_union_poi_police(df_, label_poi=TYPE_POI):
    """
...
def test_join_collective_areas(gdf_, gdf_rules_, label_geometry=GEOMETRY):
    """
...
def test_reset_and_creates_id_and_lat_lon(df_, df_pois, reset_index=True):
    """
...
def test_reset_set_window__and_creates_event_id_type(
...
def test_join_with_pois(
    ...
    try:
        ...
        values = test_reset_and_creates_id_and_lat_lon(df_, df_pois, reset_index)
...
def test_join_with_poi_datetime(
    ...
    try:
        ...
        values = test_reset_set_window__and_creates_event_id_type(
            df_, df_events, label_date, time_window
        )
