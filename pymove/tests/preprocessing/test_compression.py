...
def test_compress_segment_to_stop_point():
    ...
    move_df['dist_to_prev'] = [nan, nan, nan, 1.8315003203265166, 2.786977605326357]
    move_df['time_to_prev'] = [nan, nan, nan, 5.0, 5.0]
    move_df['speed_to_prev'] = [nan, nan, nan, 0.3663000640653033, 0.5573955210652713]
    move_df['stop'] = [False, False, True, True, True]
    cols = [
        'lat', 'lon', 'datetime', 'id',
        'segment_stop', 'dist_to_prev', 'time_to_prev', 'speed_to_prev',
        'stop', 'lat_mean', 'lon_mean'
    ]
    ...
    expected = DataFrame(data=[
        [39.984093, 116.319237, Timestamp('2008-10-23 05:53:05'), 1, 1,
         nan, nan, nan, False, nan, nan],
        [39.9842, 116.319321, Timestamp('2008-10-23 05:53:06'), 1, 2,
         nan, nan, nan, False, nan, nan],
        [39.984222, 116.319405, Timestamp('2008-10-23 05:53:11'), 1, 3,
         nan, nan, nan, True, 39.984222, 116.319405],
        [39.984219, 116.31942, Timestamp('2008-10-23 05:53:21'), 1, 3,
         2.786977605326357, 5.0, 0.5573955210652713, True, 39.984222, 116.319405],
    ], columns=cols, index=[0, 1, 2, 4]
    )
    ...
    expected = DataFrame(data=[
        ...
        [39.9842, 116.319321, Timestamp('2008-10-23 05:53:06'), 1, 2,
         nan, nan, nan, False, nan, nan],
        [39.984222, 116.319405, Timestamp('2008-10-23 05:53:11'), 1, 3,
         nan, nan, nan, True, 39.984217, 116.319405],
        [39.984219, 116.31942, Timestamp('2008-10-23 05:53:21'), 1, 3,
         2.786977605326357, 5.0, 0.5573955210652713, True, 39.984217, 116.319405],
    ], columns=cols, index=[0, 1, 2, 4]
    )
