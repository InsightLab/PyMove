...
expected_range_MEDT_data = [[33.1, -77.0, Timestamp('2012-05-19 00:00:00'),
                            '            ALBERTO'],
                            [32.8, -77.1, Timestamp('2012-05-19 06:00:00'),
                            '            ALBERTO'],
                            [32.5, -77.3, Timestamp('2012-05-19 12:00:00'),
...
expected_knn_MEDT_data = [[16.4, -54.9, Timestamp('2014-10-11 18:00:00'),
                          ...
                          [17.6, -62.4, Timestamp('2014-10-13 18:00:00'),
                          '            GONZALO'],
                          [33.1, -77.0, Timestamp('2012-05-19 00:00:00'),
                          '            ALBERTO'],
                          [32.8, -77.1, Timestamp('2012-05-19 06:00:00'),
                          '            ALBERTO'],
                          [32.5, -77.3, Timestamp('2012-05-19 12:00:00'),
...
def test_range_query():
    ...
    medt_move_df = query.range_query(traj_df, move_df, range=100, distance='MEDT')
