...
def test_create_update_datetime_in_format_cyclical():
    ...
    expected = DataFrame(data=[
        ...
        [39.984224, 116.319402, Timestamp('2008-10-23 05:53:11'),
         2, 0.979084, 0.203456],
        [39.984224, 116.319402, Timestamp('2008-10-23 05:53:15'),
         2, 0.979084, 0.203456]
    ], columns=cols + ['hour_sin', 'hour_cos'], index=[0, 1, 2, 3]
    )
...
def test_create_or_update_move_stop_by_dist_time():
    ...
    expected = DataFrame(data=[
        ...
        [3, 2, 39.984224, 116.319402, Timestamp('2008-10-23 05:53:11'),
         nan, nan, nan, True],
        [3, 2, 39.984224, 116.319402, Timestamp('2008-10-23 05:53:15'),
         0.0, 4.0, 0.0, True]
...
def test_create_update_move_and_stop_by_radius():
    ...
    expected = DataFrame(data=[
        [1, 39.984094, 116.319236, Timestamp('2008-10-23 05:53:05'),
         nan, 13.690153134343689, nan, 'nan'],
        [1, 39.984198, 116.319322, Timestamp('2008-10-23 05:53:06'),
         13.690153134343689, nan, nan, 'move'],
